...
tamanios = [60, 40]
colores=['orange','blue'] 
tamanios = [tamanios[row['top']] for _, row in artists_billboard.iterrows()]
asignar=[]
asignar2=[]
for index, row in artists_billboard.iterrows():
    asignar.append(colores[row['top']])
...
columns_to_view = ['id', 'title', 'artist', 'mood', 'tempo', 'genre', 'artist_type', 'chart_date']
selected_data = artists_billboard[columns_to_view]
